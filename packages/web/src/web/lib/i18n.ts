...
• Синя нижча за сіру → Live стабільніший (рідко)`,
    ...
    // upload modal — live trades
    uploadRequiredFields: 'Формат файлу та обов\'язкові поля',
    uploadTableExample: 'Приклад таблиці',
    uploadFieldDate: 'Date',
    uploadFieldDateFmt: 'формат YYYY-MM або YYYY-MM-DD',
    uploadFieldDir: 'Direction',
    uploadFieldSession: 'Session',
    uploadFieldResult: 'Result',
    uploadWarning: 'Файл має бути у форматі Excel (.xlsx) або CSV. Також підтримується скріншот таблиці (фото/зображення).',
    uploadCopyHint: 'Скопіюй шаблон та встав у Excel або Google Sheets. Заповни дані й збережи файл — потім завантаж сюди.',
    uploadCopyBtn: 'Скопіювати шаблон',
    uploadCopied: 'Скопійовано!',
    uploadGotIt: 'Зрозуміло, перейти до завантаження',
    uploadOrPaste: 'Або вставте зображення',
    uploadColDate: 'Дата',
    uploadColDir: 'Напрямок',
    uploadColResult: 'Результат',
    uploadColSession: 'Сесія',
    uploadColAsset: 'Актив',
    aiParsing: 'Розпізнаю таблицю...',
    aiRecognized: (n: number) => `Розпізнано ${n} угод. Перевір і підтверди:`,
    aiSaveBtn: 'Зберегти вибрані',
    aiSaving: 'Зберігаю...',
    aiSaved: (n: number) => `Збережено ${n} угод`,
  },
  en: {
    // common
    loading: 'Loading...',
...
• Blue lower than grey → Live more stable (rare)`,
    ...
    // upload modal — live trades
    uploadRequiredFields: 'File format & required fields',
    uploadTableExample: 'Table example',
    uploadFieldDate: 'Date',
    uploadFieldDateFmt: 'format YYYY-MM or YYYY-MM-DD',
    uploadFieldDir: 'Direction',
    uploadFieldSession: 'Session',
    uploadFieldResult: 'Result',
    uploadWarning: 'File must be Excel (.xlsx) or CSV. Screenshot of the table (photo/image) is also supported.',
    uploadCopyHint: 'Copy the template and paste into Excel or Google Sheets. Fill in your data, save the file — then upload here.',
    uploadCopyBtn: 'Copy template',
    uploadCopied: 'Copied!',
    uploadGotIt: 'Got it, proceed to upload',
    uploadOrPaste: 'Or paste an image',
    uploadColDate: 'Date',
    uploadColDir: 'Direction',
    uploadColResult: 'Result',
    uploadColSession: 'Session',
    uploadColAsset: 'Asset',
    aiParsing: 'Recognising table...',
    aiRecognized: (n: number) => `Recognised ${n} trades. Review and confirm:`,
    aiSaveBtn: 'Save selected',
    aiSaving: 'Saving...',
    aiSaved: (n: number) => `Saved ${n} trades`,
  },
} as const;
